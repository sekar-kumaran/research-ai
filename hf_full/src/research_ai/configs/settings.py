...
class LLMSettings:
    ...
    provider: str = field(default_factory=lambda: os.getenv("CLOUD_LLM_PROVIDER", "omnirouter").strip().lower())
    ...
    # OmniRouter: local OpenAI-compatible proxy (localhost:20218/v1) — no rate limits
    omnirouter_base_url: str = field(default_factory=lambda: os.getenv("OMNIROUTER_BASE_URL", "http://localhost:20218/v1"))
    omnirouter_api_key: str = field(default_factory=lambda: os.getenv("OMNIROUTER_API_KEY", ""))
    omnirouter_model: str = field(default_factory=lambda: os.getenv("OMNIROUTER_MODEL", "auto/best-chat"))
    ...
    ollama_model: str = field(default_factory=lambda: os.getenv("OLLAMA_MODEL", os.getenv("PRIMARY_MODEL", "llama3.1:8b")))
    ollama_base_url: str = field(default_factory=lambda: os.getenv("OLLAMA_BASE_URL", "http://localhost:11434"))
    ollama_api_key: str = field(default_factory=lambda: os.getenv("OLLAMA_API_KEY", ""))
    primary_model: str = field(default_factory=lambda: os.getenv("PRIMARY_MODEL", "auto/best-chat"))
    reasoning_model: str = field(default_factory=lambda: os.getenv("REASONING_MODEL", os.getenv("PRIMARY_MODEL", "auto/best-reasoning")))
    fast_model: str = field(default_factory=lambda: os.getenv("FAST_MODEL", "auto/fast"))
    technical_model: str = field(default_factory=lambda: os.getenv("TECHNICAL_MODEL", os.getenv("REASONING_MODEL", "auto/best-coding")))
    fallback_models: str = field(default_factory=lambda: os.getenv("FALLBACK_MODELS", "auto/best-free"))
    request_timeout: int = field(default_factory=lambda: int(os.getenv("REQUEST_TIMEOUT", "30")))
    model_timeout: int = field(default_factory=lambda: int(os.getenv("MODEL_TIMEOUT", os.getenv("OLLAMA_TIMEOUT", "120"))))
...
class RetrievalSettings:
    ...
    default_top_k: int = field(default_factory=lambda: int(os.getenv("TOP_K", "5")))
    max_top_k: int = field(default_factory=lambda: int(os.getenv("MAX_RETRIEVAL_RESULTS", "20")))
    keyword_weight: float = 0.25
    semantic_weight: float = 0.75
    paper_search_provider: str = field(default_factory=lambda: os.getenv("PAPER_SEARCH_PROVIDER", "auto").strip().lower())
    arxiv_enabled: bool = field(default_factory=lambda: os.getenv("ARXIV_ENABLED", "true").lower() == "true")
    crossref_enabled: bool = field(default_factory=lambda: os.getenv("CROSSREF_ENABLED", "true").lower() == "true")
    openalex_enabled: bool = field(default_factory=lambda: os.getenv("OPENALEX_ENABLED", "true").lower() == "true")
